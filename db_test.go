...
//		name                            string
//		db                              *DB
//		ddoc, updateFunc, docID, update string
//		options                         Options
//		expected                        *Rows
//		status                          int
//		err                             string
...
//			db: &DB{
//				driverDB: &mock.DB{
//					UpdateFunc: func(_ context.Context, ddoc, updateFunc, docID, update string, ret interface{}, opts map[string]interface{}) (interface{}, error) {
//						return nil, errors.New("db error")
//					},
//				},
//			},
...
//			a string
//		  }
//			result, err := test.db.Update(context.Background(), test.ddoc, test.updateFunc, test.docID, test.update, ret, test.options)
//			testy.StatusError(t, test.err, test.status, err)
//			//result.cancel = nil // Determinism
//			//if d := diff.Interface(test.expected, result); d != nil {
//			//	t.Error(d)
